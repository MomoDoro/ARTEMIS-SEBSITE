...
const yearlyPercentages: Record<number, Percentages> = {
  2015: { accuracy: '85.00%', error: '15.00%', rmse: '13.00%', mape: '10.00%' },
  ...
  2021: { accuracy: '91.00%', error: '9.00%', rmse: '7.00%', mape: '4.00%' },
  2022: { accuracy: '92.00%', error: '8.00%', rmse: '6.00%', mape: '3.00%' },
  2023: { accuracy: '93.00%', error: '7.00%', rmse: '5.00%', mape: '2.00%' },
};
